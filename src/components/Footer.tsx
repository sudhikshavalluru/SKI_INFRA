      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold tracking-tight text-white">
                Sri Karthikeya Infra
              </span>
            </Link>
            <p className="text-gray-400 leading-relaxed">
              Leading the way in lift and elevator solutions. Sri Karthikeya Infra (SKI) provides safe, reliable, and innovative lift services for residential and commercial buildings.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span>16-334, South Street, Venkatagiri, 524132, Tirupati district</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="text-blue-500 shrink-0" size={18} />
                <span>+91 94906 68611</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="text-blue-500 shrink-0" size={18} />
                <span>srikarthikeyainfra55@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-gray-500">
            © {currentYear} Sri Karthikeya Infra. All rights reserved.
          </p>
